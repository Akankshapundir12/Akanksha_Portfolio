import { meta, shopify, starbucks, tesla, autodesk, bluestock, aspirenex, glbajaj, dps, icdt, hackathon, deloitte, research, organizinghead, finxthon, altair, codsoft, bharat, aws, aps, sap, winner, cdg, semifinalist} from "../assets/images";
import {
    car,
    contact,
    css,
...
export const certifications = [
    ...
    "Cisco - Introduction to Cybersecurity and Python Essentials 1 & 2",
    "PaloAlto Networks - Cyber security",
    "Zscaler - Introduction to Networking for Cyber Professionals Course",
    "Coursera - Introduction to C++ ",
    "Coding Ninjas - Introduction to DSA in C++",
    "Amazon AWS - Cloud Foundation and Architecting",
    "Great Learning - Front-end Development - HTML "
];
