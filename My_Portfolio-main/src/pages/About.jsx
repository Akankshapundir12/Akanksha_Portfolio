    ...
    <section className='max-container'>
      ...
      <div className='mt-5 flex flex-col gap-3 text-slate-500 animate-slide-up'>
        <p className='section-text text-lg leading-relaxed'>
          A Final-year Computer Science student passionate about building real-world tech solutions. I enjoy working on innovative projects across AI, NLP, and full-stack development—combining creativity with problem-solving to create meaningful impact. With a strong foundation in both theory and hands-on development, I’m constantly learning, experimenting, and pushing boundaries. Open to exciting opportunities where I can grow, contribute, and make a difference!
        </p>
      </div>
      ...
      <div className="py-16 flex flex-col items-center">
        ...
        <a
          href="https://drive.google.com/file/d/1Wa_7v_GoVN_40dCTqoiQXOVbDvHUIHkl/view"
          target="_blank"
